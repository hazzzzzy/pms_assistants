from fastapi import APIRouter, Header, Request, Query, BackgroundTasks
...
async def chat(req: ChatRequest,
    ...
    gen = agent_service.chat(context, background_tasks, req.question, req.thread_id, hotel_id, user_id)
...
async def get_user_thread(req: ThreadRequest = Query()):
    return await agent_service.get_user_thread(user_id=req.user_id)
